...
clinical_fname = 'clinical_features.csv'
...
def main():
    ...
    parser.add_argument('--skipmask', action="store_true", default=False, help='Use pre-existing masks instead of making new ones')
    ...
    eval = ModelEvaluator(features_df= pd.read_csv(os.path.join(args.output_dir, 'radiomics_features.csv'), sep='\t'),
